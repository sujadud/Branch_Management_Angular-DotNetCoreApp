...
This project is a comprehensive Branch Management System developed using **.NET Core** for the backend and **Angular** for the frontend. It enables efficient management of company branches across various cities, along with employee assignments and roles.
...
- **Employee List Filtering**: Filter the employee list by role and branch.
...
2. Use the navigation menu to manage branches, employees, cities, and roles.
3. On the Employee List page, use the "Role" and "Branch" dropdowns to filter the employee list.
4. Click the "Reset Filters" button to clear all applied filters.
